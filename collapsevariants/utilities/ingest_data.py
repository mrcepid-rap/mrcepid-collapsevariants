...
class IngestData:
    ...
    def _ingest_bgen_index(self, bgen_index: dict) -> Dict[str, BGENInformation]:
        ...
        later in this workflow so that it can be parallelized. This information is stored in a TypedDict (BGENInformation)
        ...
        :param bgen_index: A file containing information of bgen files to collapse on
        :return: A dictionary with keys equal to chromosome (with 'chr' prefix) and keys of BGENInformation
        """
...
def download_bgen(chrom_bgen_index: BGENInformation) -> Tuple[Path, Path, Path]:
